...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-sm border font-sans text-[12.5px] transition-colors disabled:opacity-50 disabled:pointer-events-none cursor-pointer [&_svg]:size-3.5 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:    "border-rule bg-card text-foreground hover:bg-card-2",
        primary:    "border-ink bg-ink text-paper hover:bg-ink-2",
        signal:     "border-signal bg-signal text-signal-contrast hover:bg-signal-2",
        ...
        destructive:"border-signal bg-signal text-signal-contrast hover:bg-signal-2",
      ...
      size: {
        ...
        xs:      "h-6 px-2 py-0.5 text-[11.5px] [&_svg]:size-3",
        lg:      "h-10 px-5",
        icon:    "h-8 w-8 p-0"
      }
    },
